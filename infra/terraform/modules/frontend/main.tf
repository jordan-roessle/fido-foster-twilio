# S3 bucket to store the React build artifacts
...
# Route53 DNS record for ACM cert validation
...
# Wait for cert to be validated before creating CloudFront
...
# Look up the Route53 hosted zone for your domain
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # SPA fallback - redirect 404s to index.html so React handles routing
